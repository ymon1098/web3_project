        ...
        '>
            <div className='flex flex-col items-center w-full mt-3'>
                <div className='w-full mb-6 p-2'>
                    ...
                    <p className='text-white tex-base'>Amount: {amount} ETH</p>
                </div>
            </div>
        </div>
    )
...
const Transactions = () =>{
    const {currentAccount} = useContext(TransactionContex);
        ...
        <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
            <div className='flex flex-col md:p-12 py-12 px-4'>
                {currentAccount ? (
                    ...
                    <h3 className='text-white text-3xl text-center my-2'>Connect your account to see your latest changes</h3>
                )}
